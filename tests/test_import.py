...
def test_mma_state_reset():
    from brinkgrad.optimizer import reset_mma_state, _mma_state
    reset_mma_state()
    from brinkgrad.optimizer import _mma_state as state
