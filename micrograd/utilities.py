...
alpha_min=1e-4; alpha_max=1e3; D_min=1e-15; p_simp=5.0  # alpha_max ramped in optimizer
...
def helmholtz_filter(rin, rout, V, rf):
    ...
    L = rin * v * ufl.dx
    res = LinearProblem(a, L, bcs=[], petsc_options_prefix="lp1_", petsc_options={"ksp_type":"cg","pc_type":"jacobi"}).solve()
