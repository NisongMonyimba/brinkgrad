...
We have presented \texttt{micrograd}, a complete open-source reference
...
Brinkman model;
\texttt{micrograd} demonstrates optimisation within the Brinkman--SIMP
porous-medium model.
The three-field robust projection~\cite{wang2011} is implemented
in \texttt{micrograd.manufacturability.robust\_projection()}
