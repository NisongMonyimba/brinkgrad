...
\begin{itemize}\itemsep2pt
    \item \textbf{Gray fraction}: $\grayFrac=0.074$ at $\beta=128$;
          the $<5\%$ threshold commonly required for binary manufacturability
          without post-processing has not been achieved.
    ...
    \item \textbf{Binary performance}: binary-thresholded RMSE ($0.359$)
          matches the Christmas-tree baseline ($0.329$); no manufacturable
