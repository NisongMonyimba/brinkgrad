...
A full 400-iteration optimisation on the primary $80\times20$ mesh
completes in under twenty minutes on a standard laptop (Intel Core i7,
16\,GB RAM).
The $20\times5$ screening mesh reduces iteration time to under two minutes,
enabling rapid parameter sweeps.
...
\subsection{Mesh resolution and the diffusion layer}
...
a factor of $\approx 6\times$ on the primary $80\times20$ mesh
($\Delta y = 25\,\mu$m).
