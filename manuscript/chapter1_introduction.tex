...
(i)~the benchmark demonstrates optimisation within the
Brinkman--SIMP porous-medium model;
binary-constrained optimisation lies outside the present scope
(thresholding results: Supplementary~S5); and
(ii)~finer meshes find different local minima
...
are the primary future directions.
