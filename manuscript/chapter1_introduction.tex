...
\begin{tabular}{@{}p{2.8cm}p{1.1cm}p{1.1cm}p{1.1cm}p{1.1cm}p{1.1cm}p{1.1cm}@{}}
\toprule
\textbf{Feature} & BP03 & Na22 & Fe24 & dolfin- & cashocs & \textbf{ours} \\
 & \cite{borrvall2003} & \cite{na2022} & \cite{feppon2024} & adj.~\cite{farrell2013} & \cite{blauth2023} & \\
\midrule
