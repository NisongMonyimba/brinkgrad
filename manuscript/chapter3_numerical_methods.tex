...
The \(\alpha_{\max}\) ramping described in Eq.~\eqref{eq:alpha_ramp} is recommended for finer meshes where the uniform-density starting point is more likely to stall.
