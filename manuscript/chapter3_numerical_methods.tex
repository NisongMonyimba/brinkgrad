...
Core (solver + adjoint + optimiser) & 386  & 4 files: \texttt{solver}, \texttt{adjoint}, \texttt{optimizer}, \texttt{gradient\_optimizer} \\
Utilities (filter/mesh/postprocess) & 297  & 6 files: \texttt{utilities}, \texttt{mesh}, \texttt{postprocess}, \texttt{manufacturability}, etc. \\
...
Total automated tests        & 15   & run on every \texttt{main} push \\
