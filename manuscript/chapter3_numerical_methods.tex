...
OC optimiser (default) & Pure OC achieves RMSE~$=0.0053$ (Table~\ref{tab:mma_comparison}); pure MMA stagnates; hybrid OC/MMA retained as optional & Validated by three-way comparison \\ 
