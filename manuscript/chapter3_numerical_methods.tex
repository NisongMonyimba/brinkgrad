...
\bottomrule
\multicolumn{5}{@{}l}{\footnotesize$\dagger$~The $20\times5$
mesh has only 6 outlet nodes and under-resolves the outlet
profile; this RMSE is not comparable to $80\times20$ results.}
\end{tabular}
\end{table}
...
\texttt{python scripts/optimize.py} \\
         & \quad\texttt{-{}-target linear -{}-iter 1400} \\
