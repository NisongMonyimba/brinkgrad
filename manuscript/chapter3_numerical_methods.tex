...
Each continuation strategy addresses a specific diagnosed
failure mode; Table~\ref{tab:continuation} summarises
the motivation and effect of each component.
A reviewer may reasonably ask: are all five necessary?
The answer is yes for the microfluidic mixing problem
at the operating P\'{e}clet numbers considered,
but the framework is modular --- any strategy can be
...
Hybrid OC/MMA & OC period-2 oscillations at high $\beta$ & MMA stabilises late-phase refinement \\
