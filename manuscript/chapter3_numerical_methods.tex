...
Pure-Python utility coverage is $52\%$ (\texttt{utilities.py});
FEniCSx-dependent modules (solver, adjoint, optimiser) are
validated via the CI regression test (Test~7),
