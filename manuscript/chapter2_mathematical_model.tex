...
problem on the hard-thresholded permeability design ($\rho \in \{0,1\}$,
$D = 0$ in solid) confirms that the porous optimum
exploits gray-zone diffusion (Supplementary~S5).
This gap is mechanistically consistent with a mixing objective
(Section~\ref{sec:thresholding}): the gray Brinkman design exploits
