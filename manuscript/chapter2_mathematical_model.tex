...
\begin{equation}
    ...
    \label{eq:heaviside}
\end{equation}
The sharpness parameter \(\beta\) is increased during the optimisation (from 1 to $\betaMax$) to gradually drive the design from a grey intermediate state to a near-binary fluid/solid distribution.
