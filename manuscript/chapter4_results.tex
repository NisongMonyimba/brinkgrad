...
At $V^*=0.3$ (less solid material) the design achieves RMSE~$=0.303$
with gray fraction $\grayFrac_{V*=0.3}=0.178$;
at $V^*=0.7$ (more solid) RMSE~$=0.303$
with gray fraction $=0.177$.
