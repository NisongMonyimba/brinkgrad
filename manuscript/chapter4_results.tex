...
$160\times40$ & 6400 & 41 & $\rmseHiRes$ & 400 iter, not converged \\
\bottomrule
\end{tabular}
\end{table}
...
\begin{figure}[t]
    ...
    \caption{Performance comparison on the $80\times20$ Brinkman mesh.
             ...
             Topology optimisation simultaneously reduces RMSE by~$15\%$
...
The topology-optimised design achieves RMSE~$=\rmseTopOpt$ at
$R = \hydResTopOpt\,\text{Pa}\cdot\text{s}\,\text{m}^{-2}$,
a $15\%$ reduction in concentration error and three orders of
...
(RMSE reduced from $0.329$ (best Christmas-tree configuration) to $\rmseTopOpt$, a $15\%$ improvement
in outlet fidelity).
