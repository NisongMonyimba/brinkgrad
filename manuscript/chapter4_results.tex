...
\item \textbf{Magnitude accuracy (supplementary check).}
      ...
      and does not affect OC/MMA convergence.
...
a known property of density-based topology optimisation~\cite{lazarov2016};
...
a binary geometry: the optimiser exploits diffusive transport
